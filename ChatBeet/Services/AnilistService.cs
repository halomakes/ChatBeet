...
public class AnilistService
{
    ...
    private static async Task<TResult?> GetTopSearchItemAsync<TResult, TSearch>(string keywords, Func<string, Task<ISearchResult<TSearch>>> search, Func<TSearch, Task<TResult>> fetch)
    {
